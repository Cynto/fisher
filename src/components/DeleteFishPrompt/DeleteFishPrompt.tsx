...
function DeleteFishPrompt(props: any) {
  const {userObject, item, setDeletePrompt, fillProfileFishArray, setUserObjectFunc} = props;
  ...
  return (
    <div className="absolute-background-div">
      <div role="menu" tabIndex={0} className="delete-prompt-container" onKeyDown={(e) => e.preventDefault()} onClick={(e) => e.preventDefault()}>
